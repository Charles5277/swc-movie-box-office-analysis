...
<template>
  <div class="min-h-screen bg-gradient-to-b from-neutral-100 via-neutral-50 to-neutral-100 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950">
    <!-- Color Mode Toggle -->
    ...
    <UContainer class="py-10 lg:py-12">
      ...
      <header class="mb-10 text-center relative pt-2 lg:pt-0">
        ...
        <h1 class="text-4xl lg:text-5xl font-bold mb-3 tracking-tight">
          ...
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 via-amber-500 to-orange-500 dark:from-amber-400 dark:via-amber-300 dark:to-orange-400">{{ movieInfo.title }}</span>
        </h1>
      ...
      <section class="mb-14">
        <div class="flex items-center gap-3 mb-8">
          <div class="h-9 w-1.5 bg-gradient-to-b from-amber-500 to-orange-500 rounded-full shadow-sm" />
      ...
      <footer class="pt-8 border-t border-neutral-200 dark:border-neutral-800 text-center text-sm text-neutral-500 dark:text-neutral-400">
        <p>
          資料來源：<a
