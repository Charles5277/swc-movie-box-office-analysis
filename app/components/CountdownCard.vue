  ...
  <UCard class="overflow-hidden">
    <div class="flex flex-col lg:flex-row gap-8 items-center">
      ...
      <div class="flex-shrink-0 relative">
        <div class="absolute inset-0 bg-gradient-to-br from-amber-500/20 to-orange-500/20 dark:from-amber-500/10 dark:to-orange-500/10 rounded-full blur-2xl scale-150" />
        <ProgressCircle
      ...
      <div class="flex-1 space-y-6 w-full">
        <!-- Target Info -->
        <div class="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border border-amber-200/50 dark:border-amber-700/30">
        ...
        <div class="grid gap-4 sm:grid-cols-2">
          <div class="p-5 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200/50 dark:border-emerald-700/30 transition-transform duration-200 hover:scale-[1.02]">
          ...
          >
            <div class="flex items-center gap-2 mb-2">
              <UIcon
                ...
                :class="isAchieved ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'"
              />
              <p
                :class="[
                  'text-sm font-medium',
